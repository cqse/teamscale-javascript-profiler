...
class Verifier {
    ...
    async verify(args: unknown[], expectedOutput: string,
        ...
        expect(!this.result.err).toBeTruthy();
        ...
        // Verify the output
        expect(actualCoverage && typeof actualCoverage === 'object').toBeTruthy();
        ...
        for (const [expectedLine, expectedIncrements] of Object.entries(expectedLineCoverage)) {
            ...
            expect(actualIncrements).toBeGreaterThanOrEqual(expectedIncrements);
        }
    }
