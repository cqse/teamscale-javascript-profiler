...
function startCollector(coverageTargetFile, logTargetFile, projectId) {
    const collector = spawn('node', [`${COLLECTOR_DIR}/dist/src/main.js`,
        ...
        {
            env: {
                ...process.env, TEAMSCALE_SERVER_URL: `http://localhost:${TEAMSCALE_MOCK_PORT}/`,
...
for (const study of caseStudies) {
    ...
    try {
        ...
        execSync(`node ./dist/src/main.js --include-origin "${study.includePattern}" --in-place ${fullStudyDistPath}`,
